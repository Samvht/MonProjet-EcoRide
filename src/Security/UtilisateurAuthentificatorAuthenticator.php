...
class UtilisateurAuthentificatorAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function checkCredentials($credentials, PasswordAuthenticatedUserInterface $utilisateur): bool
    {
        $isValid= $this->passwordHasher->isPasswordValid($utilisateur, $credentials);
